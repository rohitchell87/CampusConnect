...
export default function ConversationStarter({ profile, match }) {
  ...
  return (
    <div className="mb-5 overflow-hidden rounded-[24px] border border-[#7C5CFF]/20 bg-[rgba(9,11,20,0.9)] p-5 shadow-[0_24px_60px_rgba(0,0,0,0.25)] backdrop-blur-2xl">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex items-start gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#7C5CFF]/15 text-[#A78BFA]">
            <Sparkles className="h-5 w-5" />
          </div>
          <div>
            <h3 className="text-base font-semibold text-white">✨ AI Conversation Starter</h3>
            <p className="mt-1 text-sm leading-6 text-[#C4B7FF]">
